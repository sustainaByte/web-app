...
export const AuthProvider = ({ children }: any) => {
    ...
    const login = async (email: any, password: any) => {
        await fetch('https://sustainabyte-api-service-2pvo3zhaxq-ey.a.run.app/users/login', {
            method: 'POST',
            headers: {
    ...
    const register = async (email: any, password: any, name: any, surname: any, phoneNumber: any,
        ...
        await fetch('https://sustainabyte-api-service-2pvo3zhaxq-ey.a.run.app/users/register', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
